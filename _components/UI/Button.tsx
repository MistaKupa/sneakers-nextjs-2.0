...
interface ButtonProps {
  children: ReactNode;
  onClick?: () => void;
  variant: "primary" | "secondary" | "ghost" | "quantity";
  disabled?: boolean;
  loading?: boolean;
  icon?: ElementType;
...
export default function Button({
  ...
  const baseStyles =
    "w-full flex items-center justify-center gap-2 rounded-xl px-3 py-3 font-bold transition-all duration-200 focus:outline-none";
