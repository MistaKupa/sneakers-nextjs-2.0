    ...
    >
      <div className="max-w-[1440px] h-full flex flex-col justify-center gap-16  mx-auto">
        <div className="flex justify-between items-center">
          <h2 className="uppercase sm:text-lg md:text-2xl xl:text-2xl font-semibold ">
            Shop By Collection
          </h2>
          {/* <div className="flex">
            <Link
              className="uppercase font-semibold text-sm border border-dark-500 rounded-full px-2 py-1 sm:px-2 sm:py-2"
              href="/main/site/collections"
            >
              View All
            </Link>
          </div> */}
